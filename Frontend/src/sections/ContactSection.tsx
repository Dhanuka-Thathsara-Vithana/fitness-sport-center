...
const ContactSection: React.FC = () => {
  ...
  // Re-validate a single field while the user is typing (only after first blur)
  const handleChange = (
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-8 mt-4 reveal ${visible ? 'is-visible' : ''}`}>
          ...
          <aside className="bg-dark-brown border-t-[3px] border-gold p-9">
            <h3 className="font-condensed text-[1.3rem] font-extrabold tracking-[0.08em] uppercase text-off-white mb-2">
              Visit Us
            </h3>
            ...
            <div className="flex flex-col gap-6">
              {INFO.map(({ icon, label, value }) => (
                <div key={label} className="flex gap-3.5 items-start">
                  ...
                  <div>
                    <span className="block font-condensed text-[0.75rem] font-extrabold tracking-[0.16em] uppercase text-gold/70 mb-1">
                      {label}
                    </span>
                    <span className="block font-body text-[0.95rem] font-normal text-off-white/78 leading-[1.65] whitespace-pre-line">
                      {value}
                    </span>
                  </div>
                </div>
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-right text-[0.82rem] font-medium text-off-white/32 mt-1.5">
